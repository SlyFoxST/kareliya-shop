...
<body <?php body_class(); ?>>
	<div class="wrap-section_1 lazy" data-src="<?= $fields['add_img'];?>" >
		...
		<div class="section-title">
			<h1><?= $fields['title'];?></h1>
			<div class="desc"><?= $fields['desc'];?></div>
			<div class="button-cat">
				<a href="<?= PATH ?>catalog/">В каталог</a>
			</div>
		</div>
		<div class="abs-img">
			<img src="<?= get_template_directory_uri()?>/img/shahmati.png" alt="<?php the_title();?>" class="img-fluid" />
		</div>
	</div>
