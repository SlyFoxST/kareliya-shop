...
<footer class="footer">
	<div class="col1-footer">
		...
		<div class="desc-footer">
			"Карельские мастера" - компания представляющая изделия лучших мастеров Карелии изготавливающих широкий ассортимент товаров из карельской березы.
		</div>
	</div>
	<div class="col2-footer">
		<div class="menu-footer">
			...
			<div class="contacts-in">
				<div class="tel-in">
					<a href="tel:8 921 461-32-91">8 921 461-32-91</a>
				</div>
				<div class="zvon">
					Заказать обратный звонок
				</div>
				<div class="email">
					<a href="mailto:ptz-mihail@mail.ru">ptz-mihail@mail.ru</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="col4-footer">
		<div class="adress">
			<div class="title-adress"><h3>Магазин:</h3></div>
			<div class="tel-adr">
				<a href="tel:8 921 727-52-14">тел. 8 921 727-52-14</a>
			</div>
			<div class="street">
				г. Петрозаводск, наб. Онежской флотилии, 1/3 (завод «Авангард»)
			</div>
		</div>

		<div class="adress">
			<div class="title-adress"><h3>Мастерская:</h3></div>
			<div class="tel-adr">
				<a href="tel:8 921 727-52-14">тел. 8 921 461-32-91</a>
			</div>
			<div class="street">
				г. Петрозаводск, пр. Ленина, 1. Режим работы: с 10:00 до 19:00
